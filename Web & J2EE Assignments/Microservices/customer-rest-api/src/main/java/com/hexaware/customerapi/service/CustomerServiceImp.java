...
public class CustomerServiceImp implements ICustomerService {
	...
	public Product insertProductByCust(Product product) {
		...
		Product product1=restTemplate.postForObject("http://localhost:8282/api/products/add", p, Product.class);
//		ResponseEntity<Product> product2=restTemplate.postForEntity("http://localhost:8282/api/products/add", p, Product.class);
		System.out.println("Inserted product from customer MS " );
	 ...
	 public String deleteProductByCust(int id) {
		 restTemplate.delete("http://localhost:8282/api/products/delete/"+id);
		 return "Deleted";
	 }
