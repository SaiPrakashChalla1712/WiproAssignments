...
public class CustomerRestController {
	...
	@PostMapping("/insert/product-by-customer")
	public Product insertProductByCustomer(@RequestBody Product product) {
		return service.insertProductByCust(product);
	}
	@DeleteMapping("/delete/product-by-customer/{id}")
	public String deleteProductByCust(@PathVariable int id) {
		return service.deleteProductByCust(id);
	}
